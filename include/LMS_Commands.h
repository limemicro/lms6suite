...
enum eEXP_BOARD {EXP_BOARD_UNKNOWN, EXP_BOARD_UNSUPPORTED, EXP_BOARD_NO,
            ...
            EXP_BOARD_HPM1000, EXP_BOARD_MYRIAD7, EXP_BOARD_COUNT};
const char EXP_BOARD_NAMES[][80] = { "UNKNOWN", "UNSUPPORTED", "NOT AVAILABLE",
            "Myriad1", "Myriad2", "Novena", "HPM1000", "Myriad7"};
...
enum eCMD_LMS
{
	...
	CMD_BRDSPI16_WR = 0x55,//16 bit spi for stream, dataspark control
    CMD_BRDSPI16_RD = 0x56,//16 bit spi for stream, dataspark control

    CMD_BRDSPI8_WR = 0x57, //8 bit spi for stream, dataspark control
    CMD_BRDSPI8_RD = 0x58, //8 bit spi for stream, dataspark control
