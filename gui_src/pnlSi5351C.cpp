...
void pnlSi5351C::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	lblCLK0 = new wxStaticText(this, ID_STATICTEXT3, _("PLL CLK (CLK0)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	FlexGridSizer9->Add(lblCLK0, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK1 = new wxStaticText(this, ID_STATICTEXT4, _("N/A (CLK1)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	lblCLK1->Disable();
	FlexGridSizer9->Add(lblCLK1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK2 = new wxStaticText(this, ID_STATICTEXT5, _("RxCLK (CLK2)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	FlexGridSizer9->Add(lblCLK2, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK3 = new wxStaticText(this, ID_STATICTEXT6, _("RxCLK_C (CLK3)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	FlexGridSizer9->Add(lblCLK3, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK4 = new wxStaticText(this, ID_STATICTEXT7, _("TxCLK (CLK4)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	FlexGridSizer9->Add(lblCLK4, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK5 = new wxStaticText(this, ID_STATICTEXT8, _("TxCLK_C (CLK5)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer9->Add(lblCLK5, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK6 = new wxStaticText(this, ID_STATICTEXT9, _("N/A (CLK6)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	lblCLK6->Disable();
	FlexGridSizer9->Add(lblCLK6, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	lblCLK7 = new wxStaticText(this, ID_STATICTEXT10, _("N/A (CLK7)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	lblCLK7->Disable();
	FlexGridSizer9->Add(lblCLK7, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
...
void pnlSi5351C::ModifyClocksGUI()
{
    eLMS_DEV board = m_controlModule->getDeviceManager()->GetConnectedDeviceType();
    for(int i=0; i<8; ++i)
        ClockEnable(i, true);
...
void pnlSi5351C::ClockEnable(unsigned int i, bool enabled)
{
    switch(i)
    {
    case 0:
