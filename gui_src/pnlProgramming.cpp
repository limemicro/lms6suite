...
void pnlProgramming::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("File:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	lblProgressPercent = new wxStaticText(this, ID_STATICTEXT5, _("0 %"), wxDefaultPosition, wxSize(32,-1), 0, _T("ID_STATICTEXT5"));
