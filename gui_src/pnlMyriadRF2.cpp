...
void pnlMyriadRF2::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("MyriadRF2"));
	FlexGridSizer8 = new wxFlexGridSizer(0, 2, 0, 5);
	StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("PA IN"));
	FlexGridSizer10 = new wxFlexGridSizer(0, 2, 0, 2);
	StaticText15 = new wxStaticText(this, ID_STATICTEXT15, _("DTC1:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
	...
	StaticText16 = new wxStaticText(this, ID_STATICTEXT16, _("DTC2:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT16"));
	...
	chkSWC1 = new wxCheckBox(this, ID_CHECKBOX17, _("SW1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX17"));
	chkSWC1->SetValue(false);
	FlexGridSizer10->Add(chkSWC1, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	chkSWC2 = new wxCheckBox(this, ID_CHECKBOX18, _("SW2"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX18"));
	chkSWC2->SetValue(false);
	FlexGridSizer10->Add(chkSWC2, 1, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	chkSWC3 = new wxCheckBox(this, ID_CHECKBOX19, _("SW3"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX19"));
	...
	StaticBoxSizer5 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("PA OUT"));
	FlexGridSizer11 = new wxFlexGridSizer(0, 2, 0, 2);
	StaticText17 = new wxStaticText(this, ID_STATICTEXT17, _("DTC1:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT17"));
	...
	StaticText18 = new wxStaticText(this, ID_STATICTEXT18, _("DTC2:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT18"));
	...
	chkSWC1out = new wxCheckBox(this, ID_CHECKBOX20, _("SW1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX20"));
	chkSWC1out->SetValue(false);
	FlexGridSizer11->Add(chkSWC1out, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	chkSWC2out = new wxCheckBox(this, ID_CHECKBOX21, _("SW2"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX21"));
	chkSWC2out->SetValue(false);
	FlexGridSizer11->Add(chkSWC2out, 1, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	chkSWC3out = new wxCheckBox(this, ID_CHECKBOX22, _("SW3"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX22"));
	...
	StaticText14 = new wxStaticText(this, ID_STATICTEXT14, _("LNA:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT14"));
	...
	cmbLNAbypass->SetSelection( cmbLNAbypass->Append(_("LNA bypassed")) );
	cmbLNAbypass->Append(_("LNA engaged"));
