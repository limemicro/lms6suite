...
lms_suiteFrame::lms_suiteFrame(wxWindow* parent,wxWindowID id)
{
    ...
    pnlsi51->AssignToConfigurations(PLUGINS_ZIPPER | PLUGINS_STREAM);
    ...
    pnlLms6usb = new pnlLMS6002USB(Panel1, wxNewId());
    pnlLms6usb->AssignToConfigurations(PLUGINS_ALL);
